...
class FragmentTrending3 : Fragment() {

    private lateinit var recyclerViewT3: FrameLayout
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_trending3, container, false)
        init(view)
        return view
    }

    private fun init(view: View) {
        recyclerViewT3 = view.findViewById(R.id.recyclerViewTrending3)
